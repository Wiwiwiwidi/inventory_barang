...
<html lang="en">
    ...
    <h3 align="center"><img src="{{asset('gambar/logo-baru-kemhan-dok-istimewa_11.png')}}" alt="" class="brand-image img-circle" style="opacity: .9" width="200px" height="200px"><br><b>DATA BARANG MASUK</b></h3>
    <table class="static" align="center" rules="all" style="width: 95%;">
        ...
        <tbody>
            @foreach ($dtbarang_masuk as $item)
            <tr>
