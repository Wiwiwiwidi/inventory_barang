...
<!-- <img src="gambar/logo-baru-kemhan-dok-istimewa_11.png" alt="Kemhan Logo" class="brand-image img-circle elevation-3" style="opacity: .8" height="60" width="60"> -->
    <!-- Left navbar links -->
    <ul class="navbar-nav">
      <li class="nav-item">
        <a class="nav-link" data-widget="pushmenu" href="/beranda" role="button"><i class="fas fa-bars"></i></a>
      </li>
