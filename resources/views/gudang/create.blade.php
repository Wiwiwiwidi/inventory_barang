  ...
  <div class="content-wrapper">
    ...
    <div class="content-header">
      <div class="container-fluid">
        <div class="row mb-2">
          <div class="col-sm-6">
            <h1 class="m-0"><center>TAMBAH GUDANG</center></h1>
          </div><!-- /.col -->
          <div class="col-sm-6">
    ...
    <div class="card-body">
      <form action="{{ route('gudang.store') }}" method="post">
          ...
          <div class="form-group">
              ...
              <textarea name="lokasi" class="form-control" value="{{ old('lokasi') }}" required></textarea>
          ...
          <div class="form-group">
              ...
              <a class="btn btn-primary btn-sm" href="{{ route('gudang.index') }}"> Kembali</a>
          </div>
    </div>
      </form>
            </table>
